package com.miniProject.authApp.rabbitmq;
...
public class MessageConfiguration {
    ...
    private String exchageName="anime_exchange";
    private String queueName="anime_queue";
    ...
    public Binding getBinding(Queue queue,DirectExchange directExchange){
        return BindingBuilder.bind(queue).to(directExchange).with("anime_path");
    }
}
